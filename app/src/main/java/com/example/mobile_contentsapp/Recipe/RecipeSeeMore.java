...
public class RecipeSeeMore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipeProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RecipeSeeMore.this, ProfileActivityOther.class);
        ...
        heartBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clickHeart(heart_post_id,id,heartValue);
    ...
    public void findRecipe(int id){
        ...
        call.enqueue(new Callback<RecipeFindGet>() {
            ...
            public void onResponse(Call<RecipeFindGet> call, Response<RecipeFindGet> response) {
                ...
                recipeTimeText.setText(String.format("%d:%02d",recipe_find_get.getTime()/60,recipe_find_get.getTime()%60));
    ...
    public void setHeart(int id){
        ...
        Call<HeartFindPost> call = HeartFindClient.getApiService().heartFindCall(tokenValue,id);
        call.enqueue(new Callback<HeartFindPost>() {
            ...
            public void onResponse(Call<HeartFindPost> call, Response<HeartFindPost> response) {
                ...
                Log.d(TAG, "onResponse: 성공"+response.body().isExist());
                if (response.body().isExist()){
                    heartBtn.setImageResource(R.drawable.ic_heart_big);
                    heartValue = heartValue -1;
                    heartSelect = true;
                }else{
                    heartBtn.setImageResource(R.drawable.ic_heart_white);
                    heartSelect = false;
                }
            }
    ...
    public void clickHeart(HeartPostId heart_post_id,int id,int heart){
        if (heartSelect){
            Call<HeartPostId> call = HeartCancelClient.getApiService().cancelCall(tokenValue,id);
